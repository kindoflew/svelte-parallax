...
<Parallax sections={4} style={"background-color: lightblue;"}>
  <ParallaxLayer offset={0} rate={1} style={"display: flex; justify-content: center; align-items: center;"}>
    <h1>Scroll Down!</h1>
  </ParallaxLayer>
    ...
    <div style="width: 20rem; margin-left: auto; margin-right: 3rem;">
      {#each { length: 5 } as _, index (index)}
        <p>
          ...
          veniam doloribus! Quasi a earum inventore eaque doloremque voluptatem
          mollitia, numquam, laboriosam dicta repellat accusantium cumque unde,
          dolore ex accusamus eos.
        </p>
      {/each}
    </div>
  </ParallaxLayer>
  ...
  >
    <div
      ...
      style="background-color: rebeccapurple; margin-left: 5rem; transform: rotate({progress * 360}deg)"
    />
  </StickyLayer>
